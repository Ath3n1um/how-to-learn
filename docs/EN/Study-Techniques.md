...
Consists of asking questions such as "Why?". A meta-analysis found a large effect size in science learning and a medium effect size for English [^1]. One study found that elaborative interrogation improved comprehension; however, it had no effect on retention [^2], while another study showed improved retention for expository texts [^3].

- #### Self-Explanation
Consists of stating or writing a concept in your own words. A meta-analysis found a moderate effect size on learning [^4]. A systematic review found benefits for procedural and conceptual learning, though effects decrease as information complexity increases and prior knowledge decreases [^5]. Another meta-analysis found a medium effect for mathematics and science and a small effect for English [^1].
...
A systematic review and meta-analysis found that spaced retrieval practice improved retention and knowledge acquisition. [^8] Another meta-analysis found that for mathematics, the effect on learning was low to medium [^9].
...
A meta-analysis found that interleaved practice is most effective when topics or problem types are similar to one another, showing a small positive effect in mathematics and a negative effect on learning words and expository texts [^10]. A study found similar results in mathematics learning [^11], and another showed improved retention and problem-solving ability in physics [^12].

### Wakeful Rest
Consists, as the name implies, of resting while awake. It is worth clarifying that it differs from meditation, as you are not trying to think of nothing; instead, you allow your mind to wander. A systematic review and meta-analysis found a significant effect on memory consolidation and noted that the following factors do not influence the effect: light, body position, and whether eyes were open or closed. However, the effect was larger in older adults compared to young adults. [^13]
